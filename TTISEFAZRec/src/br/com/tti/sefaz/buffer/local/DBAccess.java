...
public class DBAccess implements DBAAccessInterface, DataNotifier {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(ac
					.findXML("46052738274014363952368958840745247417132336"));
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
