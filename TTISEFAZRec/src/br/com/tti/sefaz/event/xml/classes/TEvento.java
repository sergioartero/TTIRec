 ...
 * 
 * <p>
 * Java class for TEvento complex type.
 * 
 * <p>
...
@XmlType(name = "TEvento", namespace = "http://www.portalfiscal.inf.br/nfe", propOrder = { "infEvento" })
@Embeddable
public class TEvento implements Serializable {
	...
	@Transient
	transient protected SignatureType signature;
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "cOrgao", "tpAmb", "cnpj", "cpf",
			"chNFe", "dhEvento", "tpEvento", "nSeqEvento", "verEvento",
			"detEvento" })
	@Embeddable
	public static class InfEvento implements Serializable {
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "descEvento", "xCorrecao", "xJust" })
		@Embeddable
		public static class DetEvento implements Serializable {
			...
			@XmlElement(namespace = "http://www.portalfiscal.inf.br/nfe", required = true)
			@Column(length = 1000,name="XCONDUSO")			
