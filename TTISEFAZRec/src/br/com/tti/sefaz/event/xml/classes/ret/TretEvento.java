 ...
 * 
 * <p>
 * Java class for TretEvento complex type.
 * 
 * <p>
...
@Embeddable
public class TretEvento implements Serializable {
	...
	// @Transient
	transient protected String versao;
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "tpAmb", "verAplic", "cOrgao", "cStat",
			"xMotivo", "chNFe", "tpEvento", "xEvento", "nSeqEvento",
			"cnpjDest", "cpfDest", "emailDest", "dhRegEvento", "nProt" })
	@Embeddable
