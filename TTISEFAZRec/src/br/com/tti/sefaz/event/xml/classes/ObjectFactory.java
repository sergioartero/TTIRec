...
import br.com.tti.sefaz.event.xml.classes.KeyInfoType;
import br.com.tti.sefaz.event.xml.classes.ReferenceType;
import br.com.tti.sefaz.event.xml.classes.SignatureType;
import br.com.tti.sefaz.event.xml.classes.SignatureValueType;
import br.com.tti.sefaz.event.xml.classes.SignedInfoType;
import br.com.tti.sefaz.event.xml.classes.TEnvEvento;
import br.com.tti.sefaz.event.xml.classes.TEvento;
import br.com.tti.sefaz.event.xml.classes.TProcEvento;
import br.com.tti.sefaz.event.xml.classes.TRetEnvEvento;
import br.com.tti.sefaz.event.xml.classes.TransformType;
import br.com.tti.sefaz.event.xml.classes.TransformsType;
import br.com.tti.sefaz.event.xml.classes.TretEvento;
import br.com.tti.sefaz.event.xml.classes.X509DataType;

/**
 * This object contains factory methods for each Java content interface and Java
 * element interface generated in the br.com.taragona.nfe.event.xml.classes
 * package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _EnvEvento_QNAME = new QName(
			"http://www.portalfiscal.inf.br/nfe", "envEvento");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: br.com.taragona.nfe.event.xml.classes
	 * 
	 */
	...
	public JAXBElement<TEnvEvento> createEnvEvento(TEnvEvento value) {
		return new JAXBElement<TEnvEvento>(_EnvEvento_QNAME, TEnvEvento.class,
				null, value);
	}
